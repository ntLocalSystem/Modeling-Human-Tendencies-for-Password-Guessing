...
file_name = "..\\gru_pwd_best_64.txt"
ascii_file_name = "..\\gru_pwd_best64_ascii.txt"
cleaned_file_name = "..\\gru_pwd_best64_cleaned.txt"

checking = os.path.join("..", "Password Guess Files", "lstm_pwd_best64_cleaned.txt")
