...
if __name__ == "__main__":
    inference_model = tf.keras.models.load_model(".\\H5-Inference-Checkpoint-034.h5")
    tokenizer = loadTokenizer("prototypeTokenizer.json")
    pwd_guesser = Guesser(INFERENCE_MODEL = inference_model, OP_FILE = "password_guesses_gru_testing_second.txt", VOCAB_SIZE = 70,
                        GRU_UNITS = 300, PREDICTION_BATCH_SIZE = 32, RECUR_BATCH_SIZE = 32, TOKENIZER = tokenizer,
                        ...
                        NORMALIZED_SCORE_THRESHOLD = -9.45, NORMALIZATION_ALPHA = 0.3275, UNLIMITED_GENERATION = True,
